...
public class MainActivity extends AppCompatActivity
        implements
        // NotificationsRecyclerViewAdapter.ItemClickListener,
        ...
        , AdapterView.OnItemClickListener
{
    ...
    private static NotificationsRecyclerViewAdapter recyclerViewAdapter;
    private static AlertAdaptorClassic listViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        classic
        adapter = new AlertAdaptor(stockService.Notifications, getApplicationContext());
        listView.setAdapter(adapter);
         */

        listViewAdapter = new AlertAdaptorClassic(stockService.Notifications, getApplicationContext());
        listViewAdapter.SetStockService(stockService);
        recyclerViewAdapter = new NotificationsRecyclerViewAdapter(this, stockService.Notifications);

        final LinearLayoutManager llm = new LinearLayoutManager(this);
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        // NotificationsRecyclerViewAdapter.setLayoutManager(llm);
...
/*
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                NotificationModel dataModel= stockService.Notifications.get(position);


                LinearLayout actionButtons = (LinearLayout) view.findViewById(R.id.actionButtons);
                int vis = actionButtons.getVisibility();
                actionButtons.setVisibility(actionButtons.getVisibility() == View.GONE ? View.VISIBLE : View.GONE );
                mSelectedNotification = position;

                /*Snackbar.make(view, dataModel.message, Snackbar.LENGTH_LONG)
...
/*
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                actionButtons = (LinearLayout) view.findViewById(R.id.actionButtons);
                int vis = actionButtons.getVisibility();
                actionButtons.setVisibility(actionButtons.getVisibility() == View.GONE ? View.VISIBLE : View.GONE );
                // mSelectedNotification = position;
...
*/
        if(runnable == null) {
            runnable = new Runnable() {
                public void run() {
                    new AsyncHttpRequestTask(stockService, listViewAdapter, recyclerViewAdapter).execute("list");

                    // recyclerViewAdapter.notifyDataSetChanged();
                    NotificationModel newItem = new NotificationModel();
                    newItem.headline = "Item " + String.valueOf(stockService.Notifications.size());
                    // if(before < 5)
                    // adapter.Add(newItem);
                    // recyclerViewAdapter.notifyDataSetChanged();
                    ...
                    for(int i = 0; i < after - lastCount; i++){
                        ...
                        Log.d("HTTP: ", "Added " + String.valueOf(after-lastCount) + " items, heaving " + String.valueOf(stockService.Notifications.size()));
...
*/
    public void onClick(View view) {
        ...
        switch (notificationStyle) {
            ...
            case BIG_PICTURE_STYLE:
                generateBigPictureStyleNotification("Message", "","Reply");
                break;
     ...
     * Wear devices.
     */
    private void generateBigPictureStyleNotification(String message, String details, String response) {
        ...
        BigPictureStyle bigPictureStyle = new NotificationCompat.BigPictureStyle()
                ...
                // Overrides ContentTitle in the big form of the template.
                .setBigContentTitle("Easy Stock Alert")
                // Summary line after the detail section in the big form of the template.
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Button acceptButton = (Button) view.findViewById(R.id.acceptMin);
        Button rejectButton = (Button) view.findViewById(R.id.reject);
        int vis = moreLayout.getVisibility();
        // actionButtons.setVisibility(actionButtons.getVisibility() == View.GONE ? View.VISIBLE : View.GONE );
        // acceptButton.setVisibility(acceptButton.getVisibility() == View.GONE ? View.VISIBLE : View.GONE );
        // rejectButton.setVisibility(rejectButton.getVisibility() == View.GONE ? View.VISIBLE : View.GONE );
            // mSelectedNotification = position;
